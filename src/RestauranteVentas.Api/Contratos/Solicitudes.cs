...
public sealed record ActualizarProductoSolicitud(string Nombre, decimal Precio);

public sealed record CambiarEstadoProductoSolicitud(bool? EstaActivo);
...
public sealed record CancelarVentaSolicitud(string? MotivoCancelacion);
